    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('player', 'Игрок'), ('author', 'Автор контента'), ('developer', 'Разработчик'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='player', max_length=20)),
